                        ...
                        <div id="${model.modelId }">
                            ...
                            <div class="layui-inline" style="margin-top: 15px;">
                                ...
                                <div class="layui-input-inline">
                                    <input name="modelName" id="modelName" autocomplete="off" lay-verify="required"
                                           class="layui-input" type="tel" value="${model.modelName }">
                                </div>
                            </div>
                            <div class="layui-inline" style="margin-top: 15px;">
                                <label class="layui-form-label" style="width:110px;">下级模块URL：</label>
                                <div class="layui-input-inline">
                                    <input name="modelCode" id="modelCode" autocomplete="off" lay-verify="required"
                                           class="layui-input" type="tel" value="${model.modelCode }">
                                </div>
                            </div>
                            <div class="layui-inline" style="margin-top: 15px;">
                                <a class="layui-btn layui-btn-danger"
                                   href="javascript:deleteModel('${model.modelId }')">删除</a>
                            </div>
                        </div>
                    </c:forEach>
                </div>
...
layui.use(['form', 'element', 'layer'], function () {
    ...
    form.on('submit(formDemo2)', function (data) {
        ...
        layer.confirm('确定提交吗！', function () {
            url = "admin/model/addBelowModel.action?modelId=" + modelId;
...
//修改
    form.on('submit(formDemo)', function (data){
            ...
            var index = parent.layer.getFrameIndex(window.name); //获取窗口索引
            layer.confirm('确定提交吗！', function(){
                url="admin/model/updateBelowModel.action";
...
<script type="text/html" id="onAddDemo">
    <div class="div">
        <div class="layui-inline" style="margin-top: 15px;">
            <label class="layui-form-label" style="width:105px;">下级模块名称：</label>
            <div class="layui-input-inline">
                <input name="modelName" id="modelName" autocomplete="off" lay-verify="required" class="layui-input"
                       type="text">
            </div>
        </div>
        <div class="layui-inline" style="margin-top: 15px;">
            <label class="layui-form-label" style="width:110px;">下级模块URL：</label>
            <div class="layui-input-inline">
                <input name="modelCode" id="modelCode" autocomplete="off" lay-verify="required" class="layui-input"
                       type="text">
            </div>
        </div>
        <div class="layui-inline" style="margin-top: 15px;">
