...
<table class="layui-table" lay-data="{ height:472, url:'admin/staff/findAll.action', page:true, limit: 10,id:'testReload',method:'post'}" lay-filter="demo">
  <thead>
    <tr>
...
<script type="text/javascript">
	...
	$(function(){
		...
		url="admin/annex/getAnnexlist.action";
		$.post(url,null,function(m){
			for(i=0;i<m.length;i++){
  ...
  $('.demoTable .layui-btn').on('click', function(){
	...
	function uploadFile(id){
	    	  layer.confirm('确定提交吗！', function(){
				...
				if($("#file").val()!=""){
					$.ajax({
				        url:"admin/staff/updateEmpPhoto.action?id="+id,
				        type:"post",
				        data:form,
				        processData:false,
				        contentType:false,
...
<div id="div2">
	<form id="oneForm">
    	...
    	<span class="layui-layer-setwin"><a class="layui-layer-ico layui-layer-close layui-layer-close1" href="javascript:quxiao2();">11111111</a></span>
