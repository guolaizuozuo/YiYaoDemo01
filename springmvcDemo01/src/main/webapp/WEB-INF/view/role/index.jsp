...
<table class="layui-table"
       lay-data="{width: 605, height:472,url:'/admin/role/getRoleAll.action', page:true, limit: 10,id:'testReload',method:'post'}"
       lay-filter="demo">
    <thead>
    <tr>
        ...
        table.on('tool(demo)', function (obj) {
            ...
            if (obj.event === 'detail') {
                layer.open({
                    ...
                    content: '/admin/role/editRoleModel.action?roleId=' + data.roleId,
                    area: ['25%', '65%'],
                    title: '分配模块',
                ...
                layer.confirm('真的删除行么', function (index) {
                    url = "/admin/role/deleteRole.action";
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input name="roleName" id="roleName" autocomplete="off" lay-verify="roleName" class="layui-input"
                           type="tel">
                </div>
            </div>
        </div>
